...
public class Weather {
		...
		public static void main(String[] args) {
			//This program will give a suggestions of what to wear on the weather(temperature)
			...
			if(temperature > 80) {
				...
				System.out.println("It's a little cooler. Perhaps wear a long-sleev shirt and jeans.");
